...
### 2026-04-03 | #プロジェクト
日本茶×かき氷カフェ：**実行フェーズ開始**。グランドオープン目標 2026-06-27。
- 実行ロードマップ: `10_projects/active/202604_SG_BAR_カフェ_実行ロードマップ.md`
- 今週Shaneがやること: URA相談予約(4/4)・Liquor Licence確認(4/5)・改装業者見積依頼(4/7)
- 書類準備済み: `10_projects/active/cafe_docs/` (URA準備ガイド・FSL申請チェックリスト・サプライヤーメール・JD)
- 次の確認ポイント: URA相談結果（Change of Use要否）→ スケジュール調整の要否
